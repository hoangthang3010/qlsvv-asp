<%@ Page Title="" Language="C#" MasterPageFile="~/trangchu.Master" AutoEventWireup="true" CodeBehind="sinhvienedit.aspx.cs" Inherits="Doanbaove.sinhvienedit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header class="w3-container w3-light-grey w3-medium">
            <h3> <strong>Sửa thông tin sinh viên</strong> </h3>
    </header>
...
&nbsp;tháng
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="tbx_email" CssClass="error" ErrorMessage="RegularExpressionValidator" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Font-Size="Smaller" ForeColor="Red">x</asp:RegularExpressionValidator>
            ...
            <tr>
                ...
                <td>
                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="tbx_dienthoai" CssClass="error" ErrorMessage="CompareValidator" Operator="DataTypeCheck" Type="Integer" Font-Size="Smaller" ForeColor="Red">x</asp:CompareValidator>
            ...
            <tr>
                <td colspan="3" class="w3-center">                   
                    <asp:Button ID="btt_add" runat="server" CssClass="w3-btn w3-green" Text="Cập Nhật" OnClick="btt_edit_Click" />
                     &nbsp;&nbsp;
